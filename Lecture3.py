...
sleepDF = mentalDF[["sleep_hours"]]

mentalDF = mentalDF.dropna(subset=["sleep_hours", "depression_score", "sleep_quality", "anxiety_score"])

X = mentalDF[["sleep_hours", "sleep_quality", "anxiety_score"]]
